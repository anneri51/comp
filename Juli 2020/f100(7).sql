...
--   Date and Time:   16:34 Wednesday July 8, 2020
--   Exported By:     ANNE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20200704094958'
...
||'MM:FK_STD_APEX_OBJ_STATUS:FK_STD_DB_OBJ_STATUS:OBJ_PAGE_GROUP:OBJ_PAGE_MODE::COLUMN_NAME:DATA_TYPE:DATA_LENGTH:DATA_DEFAULT:COLUMN_ID:NULLABLE:PAGE_COMMENT:CREATED_ON:CREATED_BY:LAST_UPDATED_ON:LAST_UPDATED_BY'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55464368876017801)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55464703586017806)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_name=>'to_check'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55465105753017815)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_name=>'not ok'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55463939466017790)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'OBJECT_NAME'
,p_operator=>'='
,p_expr=>'T_IMP_TEL_MOBILCOM_RECH'
,p_condition_sql=>'"OBJECT_NAME" = #APXWS_EXPR#'
,p_condition_display=>'#APXWS_COL_NAME# = ''T_IMP_TEL_MOBILCOM_RECH''  '
,p_enabled=>'Y'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55465595692017826)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_name=>'Row text contains ''mobilcom'''
,p_condition_type=>'SEARCH'
,p_allow_delete=>'Y'
,p_expr=>'mobilcom'
,p_enabled=>'Y'
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200703103745'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55174998350684408)
,p_plug_name=>'Object History'
,p_parent_plug_id=>wwv_flow_api.id(54995050052633737)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55175071528684409)
,p_plug_name=>'Previous Object'
,p_parent_plug_id=>wwv_flow_api.id(55174998350684408)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
,p_parent_plug_id=>wwv_flow_api.id(55175071528684409)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55175161282684410)
,p_plug_name=>'Following Object'
,p_parent_plug_id=>wwv_flow_api.id(55174998350684408)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>30
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55175310997684412)
,p_plug_name=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_parent_plug_id=>wwv_flow_api.id(55175161282684410)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
,p_plug_display_sequence=>10
...
'    left join t_db_obj_object_list ol1 on ol1.pk_db_obj_object_list = rh.FK_DB_OBJ_OBJECT_LIST',
'    left join t_db_obj_object_list ol2 on ol2.pk_db_obj_object_list = rh.FK_DB_OBJ_OBJECT_LIST_PREV',
'where FK_DB_OBJ_OBJECT_LIST_PREV =:P25_PK_DB_OBJ_OBJECT_LIST'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_document_header=>'APEX'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(55175525805684414)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ANNE'
,p_internal_uid=>55175525805684414
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55175685078684415)
,p_db_column_name=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Pk Rel Db Obj Object List Object Hist'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55175757817684416)
,p_db_column_name=>'FK_DB_OBJ_OBJECT_LIST'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Fk Db Obj Object List'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55175897377684417)
,p_db_column_name=>'FK_DB_OBJ_OBJECT_LIST_PREV'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Fk Db Obj Object List Prev'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55175928349684418)
,p_db_column_name=>'CREATED_AT'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Created At'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55176065198684419)
,p_db_column_name=>'OL1_OBJECT_TYPE'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Ol1 Object Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55176162259684420)
,p_db_column_name=>'OL1_OBJECT_NAME'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Ol1 Object Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55176215963684421)
,p_db_column_name=>'OL2_OBJECT_TYPE'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Ol2 Object Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55176364056684422)
,p_db_column_name=>'OL2_OBJECT_NAME'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Ol2 Object Name'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(55409640771035935)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'554097'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST:FK_DB_OBJ_OBJECT_LIST:FK_DB_OBJ_OBJECT_LIST_PREV:CREATED_AT:OL1_OBJECT_TYPE:OL1_OBJECT_NAME:OL2_OBJECT_TYPE:OL2_OBJECT_NAME'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55178381149684442)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>30
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55178421030684443)
,p_plug_name=>'New'
,p_parent_plug_id=>wwv_flow_api.id(55178381149684442)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55175493971684413)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(55175310997684412)
,p_button_name=>'New_HIST_OBJECT_1'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47551582506610071)
,p_button_is_hot=>'Y'
...
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(55178421030684443)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55176443866684423)
,p_name=>'P25_COLUMN_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55176593195684424)
,p_name=>'P25_DATA_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55176666497684425)
,p_name=>'P25_DATA_LENGTH'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55176711927684426)
,p_name=>'P25_DATA_PRECISION'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55176814768684427)
,p_name=>'P25_DATA_DEFAULT'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Data Default'
,p_source=>'DATA_DEFAULT'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55176971255684428)
,p_name=>'P25_NULLABLE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55177086706684429)
,p_name=>'P25_COLUMN_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55178251307684441)
,p_name=>'P25_PAGE_COMMENT'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Page Comment'
,p_source=>'PAGE_COMMENT'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55178507212684444)
,p_name=>'P25_LAST_UPDATED_ON'
,p_source_data_type=>'DATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(55178421030684443)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55178650096684445)
,p_name=>'P25_LAST_UPDATED_BY'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(55178421030684443)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Last_updated_by'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55178784509684446)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55178838285684447)
