--------------------------------------------------------
--  Datei erstellt -Sonntag-Mai-31-2020   
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."INP_BELEGE_ALL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 8201 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_REL_LEX_KTO_BEL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 19441 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_REL_VERPFL_BELEG_SRC
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_REL_VERPFL_BELEG_SRC" 
   (	"PK_REL_VERPFL_BELEG_SRC" NUMBER, 
	"FK_VERPFLEGUNGSMEHRAUFWD_DET" NUMBER, 
	"FK_INP_BELEGE_ALL" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_RRSZ1
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_RRSZ1" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_RSZB1
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_RSZB1" 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_RV_AUSZUG
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_RV_AUSZUG" 
   (	"PK_RV_AUSZUG" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_RV_AUSZUG_PAGE
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_RV_AUSZUG_PAGE" 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_RV_AUSZUG_PAGE_DET
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_RV_AUSZUG_PAGE_DET" 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_SEPA_VORLAGEN
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_SEPA_VORLAGEN" 
   (	"TYP" VARCHAR2(26 BYTE), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_STEUER_JAHR
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_STEUER_JAHR" 
   (	"PK_STEUER_JAHR" NUMBER, 
	"JAHR" NUMBER, 
	"FAELLIGKEITSDATUM" DATE, 
	"FK_FAELLIGKEITSDATUM" NUMBER, 
	"MAHNDATUM" DATE, 
	"FK_MAHNDATUM" NUMBER, 
	"EINKOMMENSTEUERBESCHEID" BLOB, 
	"UMSATZSTEUERBESCHEID" BLOB, 
	"FK_STATUS_BWA" NUMBER, 
	"FK_STATUS_EUER" NUMBER, 
	"FK_STATUS" NUMBER, 
	"CREATION_DATE" DATE, 
	"FK_STATUS_LEX_BUCH" NUMBER, 
	"FK_STATUS_STEUERBERATER" NUMBER, 
 ...
 LOB ("UMSATZSTEUERBESCHEID") STORE AS SECUREFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table T_STEUER_JAHR_TODO
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_STEUER_JAHR_TODO" 
   (	"PK_STEUER_JAHR_TODO" NUMBER, 
	"FK_JAHR" NUMBER, 
	"FK_TODO_GRP" NUMBER, 
	"DATUM_OK" DATE, 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_STEUER_JAHR_TODO_GRP
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_STEUER_JAHR_TODO_GRP" 
   (	"PK_STEUER_JAHR_TODO_GRP" NUMBER, 
	"TODO" VARCHAR2(4000 BYTE), 
	"FK_THEMA_DAUERHAFT" NUMBER, 
	"CREATION_DATE" DATE DEFAULT sysdate, 
	"FK_THEMA_MONATLICH" NUMBER, 
	"FK_THEMA_JÄHRLICH" NUMBER, 
	"STEUERBERATER_INVOLVIERT" NUMBER, 
	"FINANZAMT_INVOLVIERT" NUMBER, 
	"STEUERBERATER_EMPFÄNGER" NUMBER, 
	"STEUERBERATER_SENDER" NUMBER, 
	"FINANZAMT_EMPFÄNGER" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "COMPANY"."T_STEUER_MONAT" 
   (	"PK_STEUER_MONAT" NUMBER, 
	...
	"FK_STATUS" NUMBER, 
	"DATUM_OK" DATE, 
	"FK_FAELLIGKEITSTAG" NUMBER, 
	"FK_STEUER_JAHR" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_STEUER_MONAT_TODO
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_STEUER_MONAT_TODO" 
   (	"PK_STEUER_MONAT_TODO" NUMBER, 
	"FK_STEUER_MONAT" NUMBER, 
	"FK_TODO_GRP" NUMBER, 
	"DATUM_OK" DATE, 
	"TODO" VARCHAR2(4000 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "COMPANY"."T_STUNDENZETTEL" 
   (	"PK_STUNDENZETTEL" NUMBER(30,10), 
	...
	"FK_GEZEICHNET_VON" NUMBER(30,10), 
	"STUNDENZAHL" NUMBER(30,10), 
	"GENEHMIGT_AM" TIMESTAMP (6), 
	"EINGEREICHT_AM_PP_1" TIMESTAMP (6), 
	"EINGEREICHT_AM_PP2" TIMESTAMP (6), 
	"BESTÄTIGUNG_AM_PP1" TIMESTAMP (6), 
	"BESTÄTIGUNG_AM_PP_2" TIMESTAMP (6), 
	"KOMMENTAR" VARCHAR2(255 BYTE), 
	"CREATED_BY" VARCHAR2(255 BYTE), 
	"CREATED_AT" TIMESTAMP (6), 
	"MODIFIED_BY" VARCHAR2(255 BYTE), 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_TERMINE
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_TERMINE" 
   (	"PK_TERMIN" NUMBER, 
	"DATUM" DATE, 
	"DESCR" VARCHAR2(4000 BYTE), 
	"COMM" VARCHAR2(4000 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "COMPANY"."T_VERBRAUCHSMATERIAL" 
   (	"PK_VERBRAUCHSMATERIAL" NUMBER(30,10), 
	"VERBRAUCHSMATERIAL" VARCHAR2(255 BYTE), 
	"ANSCHAFFUNGSDATUM" TIMESTAMP (6), 
	"ANSCHAFFUNGSJAHR" NUMBER(30,10), 
	"CREATED_BY" VARCHAR2(255 BYTE), 
	"CREATED_AT" TIMESTAMP (6), 
	"MODIFIED_BY" VARCHAR2(255 BYTE), 
	"MODIFIED_AT" TIMESTAMP (6), 
	"FK_VERBR_MAT_TYP" NUMBER(30,10), 
	"FK_M_VERBR_MAT" NUMBER(30,10), 
	"COMM" VARCHAR2(255 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table T_VERPFLEGUNGSMEHRAUFWAND
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_VERPFLEGUNGSMEHRAUFWAND" 
   (	"PK_VERPFLEGUNGSMEHRAUFWAND" NUMBER, 
	"FK_MONAT" NUMBER, 
	"FK_JAHR" NUMBER, 
	"FK_STATUS" NUMBER, 
	"COMM" VARCHAR2(4000 BYTE), 
