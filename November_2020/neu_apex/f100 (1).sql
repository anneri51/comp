...
--   Date and Time:   12:11 Mittwoch Juni 10, 2020
--   Exported By:     ANNE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20200609215219'
...
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609170616'
);
end;
/
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609170617'
);
...
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609170839'
);
wwv_flow_api.create_page_plug(
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609170925'
);
wwv_flow_api.create_page_plug(
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609171009'
);
wwv_flow_api.create_page_plug(
...
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
,p_button_condition=>'P4_PK_TXT_REPLACED'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_grid_new_grid=>false
,p_database_action=>'UPDATE'
);
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(47609682580633431)
,p_branch_action=>'f?p=&APP_ID.:437:&SESSION.::&DEBUG.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47604974254633428)
,p_name=>'P4_PK_TXT_REPLACED'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Pk Txt Replaced'
,p_source=>'PK_TXT_REPLACED'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(47550299366610065)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47605451561633429)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47606019724633429)
,p_name=>'P4_FROM_TXT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47606484322633429)
,p_name=>'P4_TO_TXT'
,p_source_data_type=>'CLOB'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(93669775815433497)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47606881147633429)
,p_name=>'P4_DATUM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(93669775815433497)
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609171143'
);
wwv_flow_api.create_page_plug(
...
,p_show_detail_link=>'C'
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_detail_link=>'f?p=&APP_ID.:439:&SESSION.::&DEBUG.:RP:P439_TABLE_NAME,P439_COLUMN_NAME:#TABLE_NAME#,#COLUMN_NAME#'
...
,p_column_link=>'f?p=&APP_ID.:439:&SESSION.::&DEBUG.:RP:P439_TABLE_NAME:#TABLE_NAME#'
...
,p_column_link=>'f?p=&APP_ID.:439:&SESSION.::&DEBUG.:RP:P439_COLUMN_NAME:#COLUMN_NAME#'
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609171450'
);
wwv_flow_api.create_page_plug(
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609171553'
);
wwv_flow_api.create_page_plug(
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200609171642'
);
wwv_flow_api.create_page_plug(
