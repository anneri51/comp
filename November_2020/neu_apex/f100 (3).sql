...
--   Date and Time:   12:32 Montag Juni 22, 2020
--   Exported By:     ANNE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20200622112507'
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200613223100'
);
wwv_flow_api.create_page_plug(
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200612182646'
);
wwv_flow_api.create_page_plug(
...
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
,p_plug_source=>'select * from v_branch_from_to_all'
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_worksheet(
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PAGE_FROM:PAGE_TO:APPLICATION_ID'
);
wwv_flow_api.create_worksheet_condition(
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200622103758'
);
wwv_flow_api.create_page_plug(
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'WORKSPACE:WORKSPACE_DISPLAY_NAME:APPLICATION_ID:CREATED_ON:CREATED_BY:UPDATED_ON:UPDATED_BY:COMPONENT_SIGNATURE:APPLICATION_NAME:PAGE_ID:INTERACTIVE_REPORT_ID:REGION_ID:REGION_NAME:COLUMN_ID:COLUMN_ALIAS:DISPLAY_ORDER:COLUMN_GROUP:COLUMN_GROUP_ID:COL'
||'UMN_IDENTIFIER:REPORT_LABEL:FORM_LABEL:HTML_EXPRESSION:COLUMN_LINK:COLUMN_LINKTEXT:COLUMN_LINK_ATTR:COLUMN_LINK_CHECKSUM_TYPE:ALLOW_SORTING:ALLOW_FILTERING:ALLOW_HIGHLIGHTING:ALLOW_CTRL_BREAKS:ALLOW_AGGREGATIONS:ALLOW_COMPUTATIONS:ALLOW_CHARTING:ALLO'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'WORKSPACE:WORKSPACE_DISPLAY_NAME:APPLICATION_ID:APPLICATION_NAME:PAGE_ID:INTERACTIVE_REPORT_ID:REGION_ID:REGION_NAME:NUMBER_OF_COLUMNS:NUMBER_OF_COLUMN_GROUPS:NUMBER_OF_ALT_DEFAULT_REPORTS:NUMBER_OF_PUBLIC_REPORTS:NUMBER_OF_PRIVATE_REPORTS:MAX_ROW_CO'
||'UNT:MAX_ROW_COUNT_MESSAGE:NO_DATA_FOUND_MESSAGE:MAX_ROWS_PER_PAGE:SEARCH_BUTTON_LABEL:PAGE_ITEMS_TO_SUBMIT:BASE_TABLE_OR_VIEW:SHOW_NULLS_AS:PAGINATION_SCHEME:PAGINATION_DISPLAY_POSITION:BUTTON_TEMPLATE:SHOW_FINDER_DROP_DOWN:SHOW_REPORTS_SELECT_LIST:S'
||'HOW_DISPLAY_ROW_COUNT:SHOW_SEARCH_BAR:SHOW_SEARCH_TEXTBOX:SHOW_ACTIONS_MENU:ACTIONS_MENU_ICON:FINDER_ICON:SHOW_SELECT_COLUMNS:SHOW_ROWS_PER_PAGE:SHOW_FILTER:SHOW_SORT:SHOW_CONTROL_BREAK:SHOW_HIGHLIGHT:SHOW_COMPUTE:SHOW_AGGREGATE:SHOW_CHART:SHOW_GROUP'
||'_BY:SHOW_PIVOT:SHOW_NOTIFY:SHOW_FLASHBACK:SHOW_SAVE:SHOW_SAVE_PUBLIC:SAVE_PUBLIC_AUTH_SCHEME:SAVE_PUBLIC_AUTH_SCHEME_ID:SHOW_RESET:SHOW_DOWNLOAD:SHOW_HELP:DOWNLOAD_FORMATS:FILENAME:SEPARATOR:ENCLOSED_BY:DETAIL_LINK_TYPE:DETAIL_LINK_TARGET:DETAIL_LINK'
||'_TEXT:DETAIL_LINK_ATTRIBUTES:DETAIL_LINK_CHECKSUM_TYPE:DETAIL_LINK_CONDITION_TYPE:DETAIL_LINK_COND_TYPE_CODE:DETAIL_LINK_COND_EXPRESSION:DETAIL_LINK_COND_EXPRESSION2:DETAIL_LINK_AUTH_SCHEME:DETAIL_LINK_AUTH_SCHEME_ID:ALIAS:REPORT_ID_ITEM:MAX_QUERY_CO'
||'ST:EMAIL_FROM:FIXED_HEADER:FIXED_HEADER_MAX_HEIGHT:ICON_VIEW_ENABLED_YN:ICON_VIEW_USE_CUSTOM:ICON_VIEW_CUSTOM_LINK:ICON_VIEW_LINK_COLUMN:ICON_VIEW_IMG_SRC_COLUMN:ICON_VIEW_LABEL_COLUMN:ICON_VIEW_IMG_ATTR_TEXT:ICON_VIEW_ALT_TEXT:ICON_VIEW_TITLE_TEXT:I'
||'CON_VIEW_COLUMNS_PER_ROW:DETAIL_VIEW_ENABLED_YN:DETAIL_VIEW_BEFORE_ROWS:DETAIL_VIEW_FOR_EACH_ROW:DETAIL_VIEW_AFTER_ROWS:INTERNAL_UID:CREATED_ON:CREATED_BY:UPDATED_ON:UPDATED_BY:COMPONENT_SIGNATURE:LINK_TO_PAGE'
);
wwv_flow_api.create_page_plug(
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200622112032'
);
wwv_flow_api.create_page_plug(
