...
--   Date and Time:   06:56 Freitag Juli 3, 2020
--   Exported By:     ANNE
--   Flashback:       0
--   Export Type:     Application Export
--   Version:         19.1.0.00.15
--   Instance ID:     270191861893950
--
...
,p_logo_image=>'TEXT:DATABASE_ADMINISTRATION'
...
,p_last_upd_yyyymmddhh24miss=>'20200702212307'
...
,p_list_item_link_text=>'Invalid_Regions'
,p_list_item_link_target=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'22'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(54669523290715679)
,p_list_item_display_sequence=>180
,p_list_item_link_text=>'table_columns_compare'
...
,p_list_item_link_text=>'T_DB_OBJ_OBJECT_LIST'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(47443041583609956)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200628202330'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page(
 p_id=>22
,p_user_interface_id=>wwv_flow_api.id(47574086381610126)
,p_name=>'Invalid_Regions'
,p_step_title=>'Invalid_Regions'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200627135145'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(54288479662663560)
,p_plug_name=>'Invalid_Regions'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select pr.region_name, pi.*',
'from apex_application_page_items pi',
'   left join apex_application_page_regions pr on pi.data_source_region_id = pr.region_id'))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(54288526461663560)
,p_name=>'Invalid_Regions'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_show_nulls_as=>'-'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ANNE'
,p_internal_uid=>54288526461663560
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54288967696663567)
,p_db_column_name=>'REGION_NAME'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Region Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54289288544663571)
,p_db_column_name=>'WORKSPACE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Workspace'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54289684177663571)
,p_db_column_name=>'WORKSPACE_DISPLAY_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Workspace Display Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54290071113663571)
,p_db_column_name=>'APPLICATION_ID'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Application Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54290418235663571)
,p_db_column_name=>'APPLICATION_NAME'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Application Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54290822012663571)
,p_db_column_name=>'PAGE_ID'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Page Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54291254404663573)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54291607602663573)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54292026513663573)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54292431338663573)
,p_db_column_name=>'DISPLAY_AS_CODE'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Display As Code'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54292828256663573)
,p_db_column_name=>'ITEM_DATA_TYPE'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Item Data Type'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54293262255663573)
,p_db_column_name=>'IS_REQUIRED'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Is Required'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54293634835663573)
,p_db_column_name=>'IS_QUERY_ONLY'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'Is Query Only'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54294007407663573)
,p_db_column_name=>'IS_PRIMARY_KEY'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'Is Primary Key'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54294412266663575)
,p_db_column_name=>'STANDARD_VALIDATIONS'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'Standard Validations'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54294896634663575)
,p_db_column_name=>'DISPLAY_SEQUENCE'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'Display Sequence'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54295293129663575)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54295641737663575)
,p_db_column_name=>'REGION_ID'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'Region Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54296019095663575)
,p_db_column_name=>'DATA_SOURCE_REGION'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Data Source Region'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54296411142663575)
,p_db_column_name=>'DATA_SOURCE_REGION_ID'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'Data Source Region Id'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54296826575663576)
,p_db_column_name=>'SOURCE_USED'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'Source Used'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54297281286663576)
,p_db_column_name=>'ITEM_DEFAULT'
,p_display_order=>22
,p_column_identifier=>'V'
,p_column_label=>'Item Default'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54297663555663576)
,p_db_column_name=>'ITEM_DEFAULT_TYPE'
,p_display_order=>23
,p_column_identifier=>'W'
,p_column_label=>'Item Default Type'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54298092810663576)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54298459428663576)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54298892689663576)
,p_db_column_name=>'PRE_ELEMENT_TEXT'
,p_display_order=>26
,p_column_identifier=>'Z'
,p_column_label=>'Pre Element Text'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54299220628663576)
,p_db_column_name=>'POST_ELEMENT_TEXT'
,p_display_order=>27
,p_column_identifier=>'AA'
,p_column_label=>'Post Element Text'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54299600517663576)
,p_db_column_name=>'FORMAT_MASK'
,p_display_order=>28
,p_column_identifier=>'AB'
,p_column_label=>'Format Mask'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54300060038663578)
,p_db_column_name=>'ITEM_LABEL_TEMPLATE'
,p_display_order=>29
,p_column_identifier=>'AC'
,p_column_label=>'Item Label Template'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54300498236663578)
,p_db_column_name=>'ITEM_LABEL_TEMPLATE_ID'
,p_display_order=>30
,p_column_identifier=>'AD'
,p_column_label=>'Item Label Template Id'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54300856095663578)
,p_db_column_name=>'ITEM_CSS_CLASSES'
,p_display_order=>31
,p_column_identifier=>'AE'
,p_column_label=>'Item Css Classes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54301246780663578)
,p_db_column_name=>'ITEM_ICON_CSS_CLASSES'
,p_display_order=>32
,p_column_identifier=>'AF'
,p_column_label=>'Item Icon Css Classes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54301651040663578)
,p_db_column_name=>'ITEM_TEMPLATE_OPTIONS'
,p_display_order=>33
,p_column_identifier=>'AG'
,p_column_label=>'Item Template Options'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54302023806663578)
,p_db_column_name=>'ITEM_SOURCE'
,p_display_order=>34
,p_column_identifier=>'AH'
,p_column_label=>'Item Source'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54302443429663578)
,p_db_column_name=>'ITEM_SOURCE_TYPE'
,p_display_order=>35
,p_column_identifier=>'AI'
,p_column_label=>'Item Source Type'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54302860588663579)
,p_db_column_name=>'ITEM_SOURCE_DATA_TYPE'
,p_display_order=>36
,p_column_identifier=>'AJ'
,p_column_label=>'Item Source Data Type'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54303249849663579)
,p_db_column_name=>'ENCRYPT_SESSION_STATE'
,p_display_order=>37
,p_column_identifier=>'AK'
,p_column_label=>'Encrypt Session State'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54303606178663579)
,p_db_column_name=>'SOURCE_POST_COMPUTATION'
,p_display_order=>38
,p_column_identifier=>'AL'
,p_column_label=>'Source Post Computation'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54304033995663579)
,p_db_column_name=>'READ_ONLY_CONDITION_TYPE'
,p_display_order=>39
,p_column_identifier=>'AM'
,p_column_label=>'Read Only Condition Type'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54304412893663579)
,p_db_column_name=>'READ_ONLY_CONDITION_TYPE_CODE'
,p_display_order=>40
,p_column_identifier=>'AN'
,p_column_label=>'Read Only Condition Type Code'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54304888380663579)
,p_db_column_name=>'READ_ONLY_CONDITION_EXP1'
,p_display_order=>41
,p_column_identifier=>'AO'
,p_column_label=>'Read Only Condition Exp1'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54305296536663579)
,p_db_column_name=>'READ_ONLY_CONDITION_EXP2'
,p_display_order=>42
,p_column_identifier=>'AP'
,p_column_label=>'Read Only Condition Exp2'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54305650780663581)
,p_db_column_name=>'READ_ONLY_DISPLAY_ATTR'
,p_display_order=>43
,p_column_identifier=>'AQ'
,p_column_label=>'Read Only Display Attr'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54306021530663581)
,p_db_column_name=>'LOV_NAMED_LOV'
,p_display_order=>44
,p_column_identifier=>'AR'
,p_column_label=>'Lov Named Lov'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54306448532663581)
,p_db_column_name=>'LOV_DEFINITION'
,p_display_order=>45
,p_column_identifier=>'AS'
,p_column_label=>'Lov Definition'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54306878780663581)
,p_db_column_name=>'LOV_DISPLAY_EXTRA'
,p_display_order=>46
,p_column_identifier=>'AT'
,p_column_label=>'Lov Display Extra'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54307293266663581)
,p_db_column_name=>'LOV_DISPLAY_NULL'
,p_display_order=>47
,p_column_identifier=>'AU'
,p_column_label=>'Lov Display Null'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54307670502663581)
,p_db_column_name=>'LOV_NULL_TEXT'
,p_display_order=>48
,p_column_identifier=>'AV'
,p_column_label=>'Lov Null Text'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54308077293663581)
,p_db_column_name=>'LOV_NULL_VALUE'
,p_display_order=>49
,p_column_identifier=>'AW'
,p_column_label=>'Lov Null Value'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54308468099663582)
,p_db_column_name=>'LOV_QUERY_RESULT_TRANSLATED'
,p_display_order=>50
,p_column_identifier=>'AX'
,p_column_label=>'Lov Query Result Translated'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54308860189663582)
,p_db_column_name=>'LOV_CASCADE_PARENT_ITEMS'
,p_display_order=>51
,p_column_identifier=>'AY'
,p_column_label=>'Lov Cascade Parent Items'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54309232698663582)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54309664110663582)
,p_db_column_name=>'AJAX_OPTIMIZE_REFRESH'
,p_display_order=>53
,p_column_identifier=>'BA'
,p_column_label=>'Ajax Optimize Refresh'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54310088522663582)
,p_db_column_name=>'ITEM_ELEMENT_WIDTH'
,p_display_order=>54
,p_column_identifier=>'BB'
,p_column_label=>'Item Element Width'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54310430360663582)
,p_db_column_name=>'ITEM_ELEMENT_MAX_LENGTH'
,p_display_order=>55
,p_column_identifier=>'BC'
,p_column_label=>'Item Element Max Length'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54310804819663582)
,p_db_column_name=>'ITEM_ELEMENT_HEIGHT'
,p_display_order=>56
,p_column_identifier=>'BD'
,p_column_label=>'Item Element Height'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54311251626663584)
,p_db_column_name=>'HTML_TABLE_CELL_ATTR_LABEL'
,p_display_order=>57
,p_column_identifier=>'BE'
,p_column_label=>'Html Table Cell Attr Label'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54311633926663584)
,p_db_column_name=>'HTML_TABLE_CELL_ATTR_ELEMENT'
,p_display_order=>58
,p_column_identifier=>'BF'
,p_column_label=>'Html Table Cell Attr Element'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54312069598663584)
,p_db_column_name=>'HTML_FORM_ELEMENT_CSS_CLASSES'
,p_display_order=>59
,p_column_identifier=>'BG'
,p_column_label=>'Html Form Element Css Classes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54312452090663584)
,p_db_column_name=>'HTML_FORM_ELEMENT_ATTRIBUTES'
,p_display_order=>60
,p_column_identifier=>'BH'
,p_column_label=>'Html Form Element Attributes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54312872312663584)
,p_db_column_name=>'FORM_ELEMENT_OPTION_ATTRIBUTES'
,p_display_order=>61
,p_column_identifier=>'BI'
,p_column_label=>'Form Element Option Attributes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54313259253663584)
,p_db_column_name=>'ITEM_BUTTON_IMAGE'
,p_display_order=>62
,p_column_identifier=>'BJ'
,p_column_label=>'Item Button Image'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54313617405663584)
,p_db_column_name=>'ITEM_BUTTON_IMAGE_ATTRIBUTES'
,p_display_order=>63
,p_column_identifier=>'BK'
,p_column_label=>'Item Button Image Attributes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54314063645663585)
,p_db_column_name=>'NEW_GRID'
,p_display_order=>64
,p_column_identifier=>'BL'
,p_column_label=>'New Grid'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54314448837663585)
,p_db_column_name=>'NEW_GRID_ROW'
,p_display_order=>65
,p_column_identifier=>'BM'
,p_column_label=>'New Grid Row'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54314850363663585)
,p_db_column_name=>'NEW_GRID_COLUMN'
,p_display_order=>66
,p_column_identifier=>'BN'
,p_column_label=>'New Grid Column'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54315240720663585)
,p_db_column_name=>'GRID_COLUMN'
,p_display_order=>67
,p_column_identifier=>'BO'
,p_column_label=>'Grid Column'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54315661364663585)
,p_db_column_name=>'GRID_COLUMN_SPAN'
,p_display_order=>68
,p_column_identifier=>'BP'
,p_column_label=>'Grid Column Span'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54316021677663585)
,p_db_column_name=>'GRID_LABEL_COLUMN_SPAN'
,p_display_order=>69
,p_column_identifier=>'BQ'
,p_column_label=>'Grid Label Column Span'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54316483396663585)
,p_db_column_name=>'GRID_COLUMN_CSS_CLASSES'
,p_display_order=>70
,p_column_identifier=>'BR'
,p_column_label=>'Grid Column Css Classes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54316870097663587)
,p_db_column_name=>'GRID_COLUMN_ATTRIBUTES'
,p_display_order=>71
,p_column_identifier=>'BS'
,p_column_label=>'Grid Column Attributes'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54317201544663587)
,p_db_column_name=>'BEGINS_ON_NEW_ROW'
,p_display_order=>72
,p_column_identifier=>'BT'
,p_column_label=>'Begins On New Row'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54317601600663587)
,p_db_column_name=>'BEGINS_ON_NEW_CELL'
,p_display_order=>73
,p_column_identifier=>'BU'
,p_column_label=>'Begins On New Cell'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54318009897663587)
,p_db_column_name=>'COLUMN_SPAN'
,p_display_order=>74
,p_column_identifier=>'BV'
,p_column_label=>'Column Span'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54318414498663587)
,p_db_column_name=>'ROW_SPAN'
,p_display_order=>75
,p_column_identifier=>'BW'
,p_column_label=>'Row Span'
,p_column_type=>'NUMBER'
,p_heading_alignment=>'RIGHT'
,p_column_alignment=>'RIGHT'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54318876399663587)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54319212516663587)
,p_db_column_name=>'ITEM_ALIGNMENT'
,p_display_order=>77
,p_column_identifier=>'BY'
,p_column_label=>'Item Alignment'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54319641957663589)
,p_db_column_name=>'INLINE_HELP_TEXT'
,p_display_order=>78
,p_column_identifier=>'BZ'
,p_column_label=>'Inline Help Text'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54320029825663589)
,p_db_column_name=>'SHOW_QUICK_PICKS'
,p_display_order=>79
,p_column_identifier=>'CA'
,p_column_label=>'Show Quick Picks'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54320440792663589)
,p_db_column_name=>'QUICK_PICK_LINK_ATTR'
,p_display_order=>80
,p_column_identifier=>'CB'
,p_column_label=>'Quick Pick Link Attr'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54320807244663589)
,p_db_column_name=>'QUICK_PICK_LABEL_01'
,p_display_order=>81
,p_column_identifier=>'CC'
,p_column_label=>'Quick Pick Label 01'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54321295431663589)
,p_db_column_name=>'QUICK_PICK_VALUE_01'
,p_display_order=>82
,p_column_identifier=>'CD'
,p_column_label=>'Quick Pick Value 01'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54321637313663589)
,p_db_column_name=>'QUICK_PICK_LABEL_02'
,p_display_order=>83
,p_column_identifier=>'CE'
,p_column_label=>'Quick Pick Label 02'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54322027932663590)
,p_db_column_name=>'QUICK_PICK_VALUE_02'
,p_display_order=>84
,p_column_identifier=>'CF'
,p_column_label=>'Quick Pick Value 02'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54322487001663590)
,p_db_column_name=>'QUICK_PICK_LABEL_03'
,p_display_order=>85
,p_column_identifier=>'CG'
,p_column_label=>'Quick Pick Label 03'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54322841125663590)
,p_db_column_name=>'QUICK_PICK_VALUE_03'
,p_display_order=>86
,p_column_identifier=>'CH'
,p_column_label=>'Quick Pick Value 03'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54323222178663590)
,p_db_column_name=>'QUICK_PICK_LABEL_04'
,p_display_order=>87
,p_column_identifier=>'CI'
,p_column_label=>'Quick Pick Label 04'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54323669743663590)
,p_db_column_name=>'QUICK_PICK_VALUE_04'
,p_display_order=>88
,p_column_identifier=>'CJ'
,p_column_label=>'Quick Pick Value 04'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54324085197663590)
,p_db_column_name=>'QUICK_PICK_LABEL_05'
,p_display_order=>89
,p_column_identifier=>'CK'
,p_column_label=>'Quick Pick Label 05'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54324402338663590)
,p_db_column_name=>'QUICK_PICK_VALUE_05'
,p_display_order=>90
,p_column_identifier=>'CL'
,p_column_label=>'Quick Pick Value 05'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54324877132663590)
,p_db_column_name=>'QUICK_PICK_LABEL_06'
,p_display_order=>91
,p_column_identifier=>'CM'
,p_column_label=>'Quick Pick Label 06'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54325207817663592)
,p_db_column_name=>'QUICK_PICK_VALUE_06'
,p_display_order=>92
,p_column_identifier=>'CN'
,p_column_label=>'Quick Pick Value 06'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54325642594663592)
,p_db_column_name=>'QUICK_PICK_LABEL_07'
,p_display_order=>93
,p_column_identifier=>'CO'
,p_column_label=>'Quick Pick Label 07'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54326090118663592)
,p_db_column_name=>'QUICK_PICK_VALUE_07'
,p_display_order=>94
,p_column_identifier=>'CP'
,p_column_label=>'Quick Pick Value 07'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54326462315663592)
,p_db_column_name=>'QUICK_PICK_LABEL_08'
,p_display_order=>95
,p_column_identifier=>'CQ'
,p_column_label=>'Quick Pick Label 08'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54326871686663592)
,p_db_column_name=>'QUICK_PICK_VALUE_08'
,p_display_order=>96
,p_column_identifier=>'CR'
,p_column_label=>'Quick Pick Value 08'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54327287040663592)
,p_db_column_name=>'QUICK_PICK_LABEL_09'
,p_display_order=>97
,p_column_identifier=>'CS'
,p_column_label=>'Quick Pick Label 09'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54327677109663592)
,p_db_column_name=>'QUICK_PICK_VALUE_09'
,p_display_order=>98
,p_column_identifier=>'CT'
,p_column_label=>'Quick Pick Value 09'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54328016937663593)
,p_db_column_name=>'QUICK_PICK_LABEL_10'
,p_display_order=>99
,p_column_identifier=>'CU'
,p_column_label=>'Quick Pick Label 10'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54328436896663593)
,p_db_column_name=>'QUICK_PICK_VALUE_10'
,p_display_order=>100
,p_column_identifier=>'CV'
,p_column_label=>'Quick Pick Value 10'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54328838225663593)
,p_db_column_name=>'INIT_JAVASCRIPT_CODE'
,p_display_order=>101
,p_column_identifier=>'CW'
,p_column_label=>'Init Javascript Code'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54329295582663593)
,p_db_column_name=>'ATTRIBUTE_01'
,p_display_order=>102
,p_column_identifier=>'CX'
,p_column_label=>'Attribute 01'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54329679075663593)
,p_db_column_name=>'ATTRIBUTE_02'
,p_display_order=>103
,p_column_identifier=>'CY'
,p_column_label=>'Attribute 02'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54330007391663593)
,p_db_column_name=>'ATTRIBUTE_03'
,p_display_order=>104
,p_column_identifier=>'CZ'
,p_column_label=>'Attribute 03'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54330402585663595)
,p_db_column_name=>'ATTRIBUTE_04'
,p_display_order=>105
,p_column_identifier=>'DA'
,p_column_label=>'Attribute 04'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54330849631663595)
,p_db_column_name=>'ATTRIBUTE_05'
,p_display_order=>106
,p_column_identifier=>'DB'
,p_column_label=>'Attribute 05'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54331263771663595)
,p_db_column_name=>'ATTRIBUTE_06'
,p_display_order=>107
,p_column_identifier=>'DC'
,p_column_label=>'Attribute 06'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
...
begin
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54331691525663595)
,p_db_column_name=>'ATTRIBUTE_07'
,p_display_order=>108
,p_column_identifier=>'DD'
,p_column_label=>'Attribute 07'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54332017260663595)
,p_db_column_name=>'ATTRIBUTE_08'
,p_display_order=>109
,p_column_identifier=>'DE'
,p_column_label=>'Attribute 08'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54332463114663595)
,p_db_column_name=>'ATTRIBUTE_09'
,p_display_order=>110
,p_column_identifier=>'DF'
,p_column_label=>'Attribute 09'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54332864835663595)
,p_db_column_name=>'ATTRIBUTE_10'
,p_display_order=>111
,p_column_identifier=>'DG'
,p_column_label=>'Attribute 10'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54333252321663596)
,p_db_column_name=>'ATTRIBUTE_11'
,p_display_order=>112
,p_column_identifier=>'DH'
,p_column_label=>'Attribute 11'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54333683800663596)
,p_db_column_name=>'ATTRIBUTE_12'
,p_display_order=>113
,p_column_identifier=>'DI'
,p_column_label=>'Attribute 12'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54334077218663596)
,p_db_column_name=>'ATTRIBUTE_13'
,p_display_order=>114
,p_column_identifier=>'DJ'
,p_column_label=>'Attribute 13'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54334497775663596)
,p_db_column_name=>'ATTRIBUTE_14'
,p_display_order=>115
,p_column_identifier=>'DK'
,p_column_label=>'Attribute 14'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54334822703663596)
,p_db_column_name=>'ATTRIBUTE_15'
,p_display_order=>116
,p_column_identifier=>'DL'
,p_column_label=>'Attribute 15'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54335261924663596)
,p_db_column_name=>'CONDITION_TYPE'
,p_display_order=>117
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54335683381663598)
,p_db_column_name=>'CONDITION_TYPE_CODE'
,p_display_order=>118
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54336042766663598)
,p_db_column_name=>'CONDITION_EXPRESSION1'
,p_display_order=>119
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54336428197663598)
,p_db_column_name=>'CONDITION_EXPRESSION2'
,p_display_order=>120
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54336844099663598)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54337291334663598)
,p_db_column_name=>'WARN_ON_UNSAVED_CHANGES_CODE'
,p_display_order=>122
,p_column_identifier=>'DR'
,p_column_label=>'Warn On Unsaved Changes Code'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54337602094663598)
,p_db_column_name=>'RESTRICTED_CHARACTERS'
,p_display_order=>123
,p_column_identifier=>'DS'
,p_column_label=>'Restricted Characters'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54338028779663598)
,p_db_column_name=>'RESTRICTED_CHARACTERS_CODE'
,p_display_order=>124
,p_column_identifier=>'DT'
,p_column_label=>'Restricted Characters Code'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54338482616663600)
,p_db_column_name=>'MAINTAIN_SESSION_STATE'
,p_display_order=>125
,p_column_identifier=>'DU'
,p_column_label=>'Maintain Session State'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54338887789663600)
,p_db_column_name=>'ITEM_PROTECTION_LEVEL'
,p_display_order=>126
,p_column_identifier=>'DV'
,p_column_label=>'Item Protection Level'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54339238235663600)
,p_db_column_name=>'ESCAPE_ON_HTTP_OUTPUT'
,p_display_order=>127
,p_column_identifier=>'DW'
,p_column_label=>'Escape On Http Output'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54339652039663600)
,p_db_column_name=>'AUTHORIZATION_SCHEME'
,p_display_order=>128
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54340073529663600)
,p_db_column_name=>'AUTHORIZATION_SCHEME_ID'
,p_display_order=>129
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54340444844663600)
,p_db_column_name=>'BUILD_OPTION'
,p_display_order=>130
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54340823950663600)
,p_db_column_name=>'BUILD_OPTION_ID'
,p_display_order=>131
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54341206342663600)
,p_db_column_name=>'ITEM_HELP_TEXT'
,p_display_order=>132
,p_column_identifier=>'EB'
,p_column_label=>'Item Help Text'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54341620139663601)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>133
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54342060568663601)
,p_db_column_name=>'LAST_UPDATED_ON'
,p_display_order=>134
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54342466692663601)
,p_db_column_name=>'COMPONENT_COMMENT'
,p_display_order=>135
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54342894950663601)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54343272661663601)
,p_db_column_name=>'COMPONENT_SIGNATURE'
,p_display_order=>137
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(54343616280664075)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'543437'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'REGION_NAME:DATA_SOURCE_REGION:DATA_SOURCE_REGION_ID:SOURCE_USED:WORKSPACE:WORKSPACE_DISPLAY_NAME:APPLICATION_ID:APPLICATION_NAME:PAGE_ID:PAGE_NAME:ITEM_NAME:DISPLAY_AS:DISPLAY_AS_CODE:ITEM_DATA_TYPE:IS_REQUIRED:IS_QUERY_ONLY:IS_PRIMARY_KEY:STANDARD_'
||'VALIDATIONS:DISPLAY_SEQUENCE:REGION:REGION_ID:ITEM_DEFAULT:ITEM_DEFAULT_TYPE:LABEL:PLACEHOLDER:PRE_ELEMENT_TEXT:POST_ELEMENT_TEXT:FORMAT_MASK:ITEM_LABEL_TEMPLATE:ITEM_LABEL_TEMPLATE_ID:ITEM_CSS_CLASSES:ITEM_ICON_CSS_CLASSES:ITEM_TEMPLATE_OPTIONS:ITEM'
||'_SOURCE:ITEM_SOURCE_TYPE:ITEM_SOURCE_DATA_TYPE:ENCRYPT_SESSION_STATE:SOURCE_POST_COMPUTATION:READ_ONLY_CONDITION_TYPE:READ_ONLY_CONDITION_TYPE_CODE:READ_ONLY_CONDITION_EXP1:READ_ONLY_CONDITION_EXP2:READ_ONLY_DISPLAY_ATTR:LOV_NAMED_LOV:LOV_DEFINITION:'
||'LOV_DISPLAY_EXTRA:LOV_DISPLAY_NULL:LOV_NULL_TEXT:LOV_NULL_VALUE:LOV_QUERY_RESULT_TRANSLATED:LOV_CASCADE_PARENT_ITEMS:AJAX_ITEMS_TO_SUBMIT:AJAX_OPTIMIZE_REFRESH:ITEM_ELEMENT_WIDTH:ITEM_ELEMENT_MAX_LENGTH:ITEM_ELEMENT_HEIGHT:HTML_TABLE_CELL_ATTR_LABEL:'
||'HTML_TABLE_CELL_ATTR_ELEMENT:HTML_FORM_ELEMENT_CSS_CLASSES:HTML_FORM_ELEMENT_ATTRIBUTES:FORM_ELEMENT_OPTION_ATTRIBUTES:ITEM_BUTTON_IMAGE:ITEM_BUTTON_IMAGE_ATTRIBUTES:NEW_GRID:NEW_GRID_ROW:NEW_GRID_COLUMN:GRID_COLUMN:GRID_COLUMN_SPAN:GRID_LABEL_COLUMN'
||'_SPAN:GRID_COLUMN_CSS_CLASSES:GRID_COLUMN_ATTRIBUTES:BEGINS_ON_NEW_ROW:BEGINS_ON_NEW_CELL:COLUMN_SPAN:ROW_SPAN:LABEL_ALIGNMENT:ITEM_ALIGNMENT:INLINE_HELP_TEXT:SHOW_QUICK_PICKS:QUICK_PICK_LINK_ATTR:QUICK_PICK_LABEL_01:QUICK_PICK_VALUE_01:QUICK_PICK_LA'
||'BEL_02:QUICK_PICK_VALUE_02:QUICK_PICK_LABEL_03:QUICK_PICK_VALUE_03:QUICK_PICK_LABEL_04:QUICK_PICK_VALUE_04:QUICK_PICK_LABEL_05:QUICK_PICK_VALUE_05:QUICK_PICK_LABEL_06:QUICK_PICK_VALUE_06:QUICK_PICK_LABEL_07:QUICK_PICK_VALUE_07:QUICK_PICK_LABEL_08:QUI'
||'CK_PICK_VALUE_08:QUICK_PICK_LABEL_09:QUICK_PICK_VALUE_09:QUICK_PICK_LABEL_10:QUICK_PICK_VALUE_10:INIT_JAVASCRIPT_CODE:ATTRIBUTE_01:ATTRIBUTE_02:ATTRIBUTE_03:ATTRIBUTE_04:ATTRIBUTE_05:ATTRIBUTE_06:ATTRIBUTE_07:ATTRIBUTE_08:ATTRIBUTE_09:ATTRIBUTE_10:AT'
||'TRIBUTE_11:ATTRIBUTE_12:ATTRIBUTE_13:ATTRIBUTE_14:ATTRIBUTE_15:CONDITION_TYPE:CONDITION_TYPE_CODE:CONDITION_EXPRESSION1:CONDITION_EXPRESSION2:WARN_ON_UNSAVED_CHANGES:WARN_ON_UNSAVED_CHANGES_CODE:RESTRICTED_CHARACTERS:RESTRICTED_CHARACTERS_CODE:MAINTA'
||'IN_SESSION_STATE:ITEM_PROTECTION_LEVEL:ESCAPE_ON_HTTP_OUTPUT:AUTHORIZATION_SCHEME:AUTHORIZATION_SCHEME_ID:BUILD_OPTION:BUILD_OPTION_ID:ITEM_HELP_TEXT:LAST_UPDATED_BY:LAST_UPDATED_ON:COMPONENT_COMMENT:ITEM_ID:COMPONENT_SIGNATURE:'
);
end;
/
...
,p_step_title=>'T_DB_OBJ_OBJECT_LIST'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200702212307'
...
,p_plug_name=>'T_DB_OBJ_OBJECT_LIST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
'    left join (select * from t_std where fk_std_group =41 ) aps on aps.std_value = obj.fk_std_apex_obj_status',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(54993281672623079)
,p_db_column_name=>'OBJECT_NAME_RPEV'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Object Name Rpev'
,p_column_type=>'STRING'
,p_heading_alignment=>'LEFT'
,p_tz_dependent=>'N'
);
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55093516725932622)
,p_db_column_name=>'FK_STD_DB_PART'
,p_display_order=>56
,p_column_identifier=>'K'
,p_column_label=>'Fk Std Db Part'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55136242445192748)
,p_db_column_name=>'FK_STD_APEX_OBJ_STATUS'
,p_display_order=>146
,p_column_identifier=>'T'
,p_column_label=>'Fk Std Apex Obj Status'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PK_DB_OBJ_OBJECT_LIST:OBJECT_TYPE:OBJECT_NAME:OBJECT_NAME_RPEV:CREATE_AT:FLG_NEU:ALLOBJ_OBJECT_NAME:FK_STD_DB_PART:PAGE_ID:APPLICATION_ID:WORKSPACE_ID:PAGE_TITLE:PAGE_MODE:OBJ_PAGE_NAME:PAGE_NAME:PAGE_GROUP:PAGE_GROUP_ID:OBJ_STATUS:APEX_OBJ_STATUS:CO'
||'MM:FK_STD_APEX_OBJ_STATUS:FK_STD_DB_OBJ_STATUS:OBJ_PAGE_GROUP:OBJ_PAGE_MODE:'
,p_sort_column_1=>'PAGE_ID'
,p_sort_direction_1=>'ASC'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55348155871273717)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55348569677273717)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_name=>'to_check'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55348966241273717)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_name=>'not ok'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55347393990273715)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'APPLICATION_ID'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55347791120273715)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
...
,p_operator=>'contains'
,p_expr=>'16'
,p_condition_sql=>'upper("PAGE_ID") like ''%''||upper(#APXWS_EXPR#)||''%'''
,p_condition_display=>'#APXWS_COL_NAME# #APXWS_OP_NAME# 16  '
,p_enabled=>'Y'
);
wwv_flow_api.create_page_button(
...
wwv_flow_api.create_page(
 p_id=>25
,p_user_interface_id=>wwv_flow_api.id(47574086381610126)
,p_name=>'Datenbank Objekt Historie'
,p_step_title=>'Datenbank Objekt Historie'
,p_autocomplete_on_off=>'OFF'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200702211401'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(54995050052633737)
,p_plug_name=>'Create Form'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>40
,p_plug_display_point=>'BODY'
,p_query_type=>'TABLE'
,p_query_table=>'T_DB_OBJ_OBJECT_LIST'
,p_include_rowid_column=>false
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_lost_update_check_type=>'VALUES'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(52628311802148339)
,p_plug_name=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_parent_plug_id=>wwv_flow_api.id(54995050052633737)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
,p_plug_display_sequence=>40
...
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST,',
'       FK_DB_OBJ_OBJECT_LIST,',
'       FK_DB_OBJ_OBJECT_LIST_PREV,',
'       CREATED_AT,',
'       ol1.object_type ol1_object_type,',
'       ol1.object_name ol1_object_name,',
'       ol2.object_type ol2_object_type,',
'       ol2.object_name ol2_object_name',
'  from T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST rh',
'    left join t_db_obj_object_list ol1 on ol1.pk_db_obj_object_list = rh.FK_DB_OBJ_OBJECT_LIST',
'    left join t_db_obj_object_list ol2 on ol2.pk_db_obj_object_list = rh.FK_DB_OBJ_OBJECT_LIST_PREV',
'where FK_DB_OBJ_OBJECT_LIST =:P25_PK_DB_OBJ_OBJECT_LIST'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_document_header=>'APEX'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(52628423079148340)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ANNE'
,p_internal_uid=>52628423079148340
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(52628590505148341)
,p_db_column_name=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Pk Rel Db Obj Object List Object Hist'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(52628912712148345)
,p_db_column_name=>'FK_DB_OBJ_OBJECT_LIST'
,p_display_order=>20
,p_column_identifier=>'E'
,p_column_label=>'Fk Db Obj Object List'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(52629007046148346)
,p_db_column_name=>'FK_DB_OBJ_OBJECT_LIST_PREV'
,p_display_order=>30
,p_column_identifier=>'F'
,p_column_label=>'Fk Db Obj Object List Prev'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(52629111338148347)
,p_db_column_name=>'CREATED_AT'
,p_display_order=>40
,p_column_identifier=>'G'
,p_column_label=>'Created At'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55014016758829123)
,p_db_column_name=>'OL1_OBJECT_TYPE'
,p_display_order=>50
,p_column_identifier=>'H'
,p_column_label=>'Ol1 Object Type'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55014104952829124)
,p_db_column_name=>'OL1_OBJECT_NAME'
,p_display_order=>60
,p_column_identifier=>'I'
,p_column_label=>'Ol1 Object Name'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55014234141829125)
,p_db_column_name=>'OL2_OBJECT_TYPE'
,p_display_order=>70
,p_column_identifier=>'J'
,p_column_label=>'Ol2 Object Type'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55014382784829126)
,p_db_column_name=>'OL2_OBJECT_NAME'
,p_display_order=>80
,p_column_identifier=>'K'
,p_column_label=>'Ol2 Object Name'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(55004267861691907)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'550043'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST:FK_DB_OBJ_OBJECT_LIST:FK_DB_OBJ_OBJECT_LIST_PREV:CREATED_AT:OL1_OBJECT_TYPE:OL1_OBJECT_NAME:OL2_OBJECT_TYPE:OL2_OBJECT_NAME'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55063356856663782)
,p_report_id=>wwv_flow_api.id(55004267861691907)
,p_name=>'ob'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'OL2_OBJECT_NAME'
,p_operator=>'is not null'
,p_condition_sql=>' (case when ("OL2_OBJECT_NAME" is not null) then #APXWS_HL_ID# end) '
,p_condition_display=>'#APXWS_COL_NAME# #APXWS_OP_NAME#'
,p_enabled=>'Y'
,p_highlight_sequence=>10
,p_column_bg_color=>'#99CCFF'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55063700819663784)
,p_report_id=>wwv_flow_api.id(55004267861691907)
,p_name=>'ot'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'OL2_OBJECT_TYPE'
,p_operator=>'is not null'
,p_condition_sql=>' (case when ("OL2_OBJECT_TYPE" is not null) then #APXWS_HL_ID# end) '
,p_condition_display=>'#APXWS_COL_NAME# #APXWS_OP_NAME#'
,p_enabled=>'Y'
,p_highlight_sequence=>10
,p_column_bg_color=>'#99CCFF'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55012567632829108)
,p_plug_name=>'T_REL_DB_OBJ_OBJECT_LIST_PART'
,p_parent_plug_id=>wwv_flow_api.id(54995050052633737)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
...
,p_query_type=>'SQL'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select PK_REL_DB_OBJ_OBJECT_LIST_PART,',
'       FK_DB_OBJ_OBJECT_LIST,',
'       FK_BAS_DB_PART,',
'       CREATION_AT,',
'       dbp.std_name,',
'       dbp.comm',
'  from T_REL_DB_OBJ_OBJECT_LIST_PART rp',
'   left join (select * from t_std where fk_std_group = 642) dbp on dbp.std_value = rp.FK_BAS_DB_PART',
'where FK_DB_OBJ_OBJECT_LIST =:P25_PK_DB_OBJ_OBJECT_LIST'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_prn_content_disposition=>'ATTACHMENT'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(55012655092829109)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y_OF_Z'
,p_pagination_display_pos=>'TOP_AND_BOTTOM_LEFT'
...
,p_show_notify=>'Y'
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_detail_link=>'f?p=&APP_ID.:33:&SESSION.::&DEBUG.:RP:P33_PK_REL_DB_OBJ_OBJECT_LIST_PART:#PK_REL_DB_OBJ_OBJECT_LIST_PART#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#app_ui/img/icons/apex-edit-pencil.png" class="apex-edit-pencil" alt="">'
,p_owner=>'ANNE'
,p_internal_uid=>55012655092829109
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55012774184829110)
,p_db_column_name=>'PK_REL_DB_OBJ_OBJECT_LIST_PART'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Pk Rel Db Obj Object List Part'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55013138374829114)
,p_db_column_name=>'FK_BAS_DB_PART'
,p_display_order=>30
,p_column_identifier=>'E'
,p_column_label=>'Fk Bas Db Part'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55013291041829115)
,p_db_column_name=>'CREATION_AT'
,p_display_order=>40
,p_column_identifier=>'F'
,p_column_label=>'Creation At'
,p_column_type=>'DATE'
,p_column_alignment=>'CENTER'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55013886393829121)
,p_db_column_name=>'STD_NAME'
,p_display_order=>50
,p_column_identifier=>'G'
,p_column_label=>'Std Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55013924746829122)
,p_db_column_name=>'COMM'
,p_display_order=>60
,p_column_identifier=>'H'
,p_column_label=>'Comm'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55014685262829129)
,p_db_column_name=>'FK_DB_OBJ_OBJECT_LIST'
,p_display_order=>70
,p_column_identifier=>'I'
,p_column_label=>'Fk Db Obj Object List'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(55032501200421856)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'550326'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PK_REL_DB_OBJ_OBJECT_LIST_PART:FK_BAS_DB_PART:CREATION_AT:STD_NAME:COMM:FK_DB_OBJ_OBJECT_LIST'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55061700871638245)
,p_report_id=>wwv_flow_api.id(55032501200421856)
,p_name=>'name'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
,p_column_name=>'STD_NAME'
,p_operator=>'is not null'
,p_condition_sql=>' (case when ("STD_NAME" is not null) then #APXWS_HL_ID# end) '
,p_condition_display=>'#APXWS_COL_NAME# #APXWS_OP_NAME#'
,p_enabled=>'Y'
,p_highlight_sequence=>10
,p_column_bg_color=>'#99CCFF'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55015473225829137)
,p_plug_name=>'Object_exists'
,p_parent_plug_id=>wwv_flow_api.id(54995050052633737)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
...
'select *',
'from all_objects',
'where object_type = :P25_Object_type and object_name = :P25_object_name'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_document_header=>'APEX'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(55015513940829138)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ANNE'
,p_internal_uid=>55015513940829138
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55015690581829139)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55015715015829140)
,p_db_column_name=>'OBJECT_NAME'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Object Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55015827910829141)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55015967690829142)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016057471829143)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016180741829144)
,p_db_column_name=>'OBJECT_TYPE'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Object Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016289499829145)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016301666829146)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016462793829147)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016520756829148)
,p_db_column_name=>'STATUS'
,p_display_order=>100
,p_column_identifier=>'J'
,p_column_label=>'Status'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016635008829149)
,p_db_column_name=>'TEMPORARY'
,p_display_order=>110
,p_column_identifier=>'K'
,p_column_label=>'Temporary'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55016781538829150)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55091457913932601)
,p_db_column_name=>'SECONDARY'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'Secondary'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55091536220932602)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55091680372932603)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55091763783932604)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55091872608932605)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55091979049932606)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092036251932607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092159389932608)
,p_db_column_name=>'DEFAULT_COLLATION'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'Default Collation'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092239851932609)
,p_db_column_name=>'DUPLICATED'
,p_display_order=>210
,p_column_identifier=>'U'
,p_column_label=>'Duplicated'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092350165932610)
,p_db_column_name=>'SHARDED'
,p_display_order=>220
,p_column_identifier=>'V'
,p_column_label=>'Sharded'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092493926932611)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092580967932612)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092635434932613)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55092775537932614)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(55105252216933512)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'551053'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55093325122932620)
,p_plug_name=>'DB Objekte'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55093457642932621)
,p_plug_name=>'Apex Objekte'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55094425394932631)
,p_plug_name=>'Object_exists'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
...
'select *',
'from apex_application_pages',
'where page_id = :p25_page_id and application_id = :P25_application_id'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_prn_content_disposition=>'ATTACHMENT'
,p_prn_document_header=>'APEX'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(55094571268932632)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ANNE'
,p_internal_uid=>55094571268932632
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55127364384188109)
,p_db_column_name=>'WORKSPACE'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Workspace'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55127430334188110)
,p_db_column_name=>'WORKSPACE_DISPLAY_NAME'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Workspace Display Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55127571614188111)
,p_db_column_name=>'APPLICATION_ID'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Application Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55127601879188112)
,p_db_column_name=>'APPLICATION_NAME'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Application Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55127704490188113)
,p_db_column_name=>'PAGE_ID'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Page Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55127875548188114)
,p_db_column_name=>'PAGE_NAME'
,p_display_order=>60
,p_column_identifier=>'F'
,p_column_label=>'Page Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55127936943188115)
,p_db_column_name=>'PAGE_TITLE'
,p_display_order=>70
,p_column_identifier=>'G'
,p_column_label=>'Page Title'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128022828188116)
,p_db_column_name=>'PAGE_MODE'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Page Mode'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128147937188117)
,p_db_column_name=>'USER_INTERFACE_ID'
,p_display_order=>90
,p_column_identifier=>'I'
,p_column_label=>'User Interface Id'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128271459188118)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128334172188119)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128493315188120)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128512641188121)
,p_db_column_name=>'PAGE_FUNCTION'
,p_display_order=>130
,p_column_identifier=>'M'
,p_column_label=>'Page Function'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128622210188122)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128768661188123)
,p_db_column_name=>'INCLUDE_APEX_CSS_JS_YN'
,p_display_order=>150
,p_column_identifier=>'O'
,p_column_label=>'Include Apex Css Js Yn'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128801969188124)
,p_db_column_name=>'FOCUS_CURSOR'
,p_display_order=>160
,p_column_identifier=>'P'
,p_column_label=>'Focus Cursor'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55128929835188125)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129091168188126)
,p_db_column_name=>'BODY_HEADER'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'Body Header'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129143330188127)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129284663188128)
,p_db_column_name=>'HELP_TEXT'
,p_display_order=>200
,p_column_identifier=>'T'
,p_column_label=>'Help Text'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129366422188129)
,p_db_column_name=>'PAGE_TEMPLATE'
,p_display_order=>210
,p_column_identifier=>'U'
,p_column_label=>'Page Template'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129494384188130)
,p_db_column_name=>'PAGE_CSS_CLASSES'
,p_display_order=>220
,p_column_identifier=>'V'
,p_column_label=>'Page Css Classes'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129589679188131)
,p_db_column_name=>'PAGE_TEMPLATE_OPTIONS'
,p_display_order=>230
,p_column_identifier=>'W'
,p_column_label=>'Page Template Options'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129631722188132)
,p_db_column_name=>'AUTHORIZATION_SCHEME'
,p_display_order=>240
,p_column_identifier=>'X'
,p_column_label=>'Authorization Scheme'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129721474188133)
,p_db_column_name=>'AUTHORIZATION_SCHEME_ID'
,p_display_order=>250
,p_column_identifier=>'Y'
,p_column_label=>'Authorization Scheme Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129817252188134)
,p_db_column_name=>'BUILD_OPTION'
,p_display_order=>260
,p_column_identifier=>'Z'
,p_column_label=>'Build Option'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55129926039188135)
,p_db_column_name=>'PAGE_HTML_HEADER'
,p_display_order=>270
,p_column_identifier=>'AA'
,p_column_label=>'Page Html Header'
,p_allow_sorting=>'N'
,p_allow_ctrl_breaks=>'N'
,p_allow_aggregations=>'N'
,p_allow_computations=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130047877188136)
,p_db_column_name=>'PAGE_HTML_ONLOAD'
,p_display_order=>280
,p_column_identifier=>'AB'
,p_column_label=>'Page Html Onload'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130177252188137)
,p_db_column_name=>'JAVASCRIPT_FILE_URLS'
,p_display_order=>290
,p_column_identifier=>'AC'
,p_column_label=>'Javascript File Urls'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130251521188138)
,p_db_column_name=>'JAVASCRIPT_CODE'
,p_display_order=>300
,p_column_identifier=>'AD'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130318027188139)
,p_db_column_name=>'JAVASCRIPT_CODE_ONLOAD'
,p_display_order=>310
,p_column_identifier=>'AE'
,p_column_label=>'Javascript Code Onload'
,p_allow_sorting=>'N'
,p_allow_ctrl_breaks=>'N'
,p_allow_aggregations=>'N'
,p_allow_computations=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130484760188140)
,p_db_column_name=>'CSS_FILE_URLS'
,p_display_order=>320
,p_column_identifier=>'AF'
,p_column_label=>'Css File Urls'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130577935188141)
,p_db_column_name=>'INLINE_CSS'
,p_display_order=>330
,p_column_identifier=>'AG'
,p_column_label=>'Inline Css'
,p_allow_sorting=>'N'
,p_allow_ctrl_breaks=>'N'
,p_allow_aggregations=>'N'
,p_allow_computations=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130613258188142)
,p_db_column_name=>'PAGE_REQUIRES_AUTHENTICATION'
,p_display_order=>340
,p_column_identifier=>'AH'
,p_column_label=>'Page Requires Authentication'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130798510188143)
,p_db_column_name=>'PAGE_ACCESS_PROTECTION'
,p_display_order=>350
,p_column_identifier=>'AI'
,p_column_label=>'Page Access Protection'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130856799188144)
,p_db_column_name=>'DIALOG_TITLE'
,p_display_order=>360
,p_column_identifier=>'AJ'
,p_column_label=>'Dialog Title'
,p_column_type=>'STRING'
);
end;
/
begin
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55130913072188145)
,p_db_column_name=>'DIALOG_HEIGHT'
,p_display_order=>370
,p_column_identifier=>'AK'
,p_column_label=>'Dialog Height'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131099144188146)
,p_db_column_name=>'DIALOG_WIDTH'
,p_display_order=>380
,p_column_identifier=>'AL'
,p_column_label=>'Dialog Width'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131142745188147)
,p_db_column_name=>'DIALOG_MAX_WIDTH'
,p_display_order=>390
,p_column_identifier=>'AM'
,p_column_label=>'Dialog Max Width'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131282118188148)
,p_db_column_name=>'DIALOG_ATTRIBUTES'
,p_display_order=>400
,p_column_identifier=>'AN'
,p_column_label=>'Dialog Attributes'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131320678188149)
,p_db_column_name=>'DIALOG_CSS_CLASSES'
,p_display_order=>410
,p_column_identifier=>'AO'
,p_column_label=>'Dialog Css Classes'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131438323188150)
,p_db_column_name=>'DIALOG_CHAINED'
,p_display_order=>420
,p_column_identifier=>'AP'
,p_column_label=>'Dialog Chained'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131555348192701)
,p_db_column_name=>'OVERWRITE_NAVIGATION_LIST'
,p_display_order=>430
,p_column_identifier=>'AQ'
,p_column_label=>'Overwrite Navigation List'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131696589192702)
,p_db_column_name=>'NAVIGATION_LIST'
,p_display_order=>440
,p_column_identifier=>'AR'
,p_column_label=>'Navigation List'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131761871192703)
,p_db_column_name=>'NAVIGATION_LIST_ID'
,p_display_order=>450
,p_column_identifier=>'AS'
,p_column_label=>'Navigation List Id'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131817456192704)
,p_db_column_name=>'NAVIGATION_LIST_TEMPLATE'
,p_display_order=>460
,p_column_identifier=>'AT'
,p_column_label=>'Navigation List Template'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55131952090192705)
,p_db_column_name=>'NAVIGATION_LIST_TEMPLATE_ID'
,p_display_order=>470
,p_column_identifier=>'AU'
,p_column_label=>'Navigation List Template Id'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132082273192706)
,p_db_column_name=>'NAV_LIST_TEMPLATE_OPTIONS'
,p_display_order=>480
,p_column_identifier=>'AV'
,p_column_label=>'Nav List Template Options'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132155636192707)
,p_db_column_name=>'NAVIGATION_LIST_POSITION'
,p_display_order=>490
,p_column_identifier=>'AW'
,p_column_label=>'Navigation List Position'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132282447192708)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132382227192709)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132430844192710)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132578289192711)
,p_db_column_name=>'COMPUTATIONS'
,p_display_order=>530
,p_column_identifier=>'BA'
,p_column_label=>'Computations'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132637130192712)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132773251192713)
,p_db_column_name=>'PROCESSES'
,p_display_order=>550
,p_column_identifier=>'BC'
,p_column_label=>'Processes'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132857782192714)
,p_db_column_name=>'BRANCHES'
,p_display_order=>560
,p_column_identifier=>'BD'
,p_column_label=>'Branches'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55132932626192715)
,p_db_column_name=>'REPORT_COLUMNS'
,p_display_order=>570
,p_column_identifier=>'BE'
,p_column_label=>'Report Columns'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133024981192716)
,p_db_column_name=>'PAGE_GROUP'
,p_display_order=>580
,p_column_identifier=>'BF'
,p_column_label=>'Page Group'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133139427192717)
,p_db_column_name=>'PAGE_GROUP_ID'
,p_display_order=>590
,p_column_identifier=>'BG'
,p_column_label=>'Page Group Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133211069192718)
,p_db_column_name=>'ON_DUP_SUBMISSION_GOTO_URL'
,p_display_order=>600
,p_column_identifier=>'BH'
,p_column_label=>'On Dup Submission Goto Url'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133383336192719)
,p_db_column_name=>'ERROR_HANDLING_FUNCTION'
,p_display_order=>610
,p_column_identifier=>'BI'
,p_column_label=>'Error Handling Function'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133442119192720)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133579311192721)
,p_db_column_name=>'FORM_AUTOCOMPLETE'
,p_display_order=>630
,p_column_identifier=>'BK'
,p_column_label=>'Form Autocomplete'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133648871192722)
,p_db_column_name=>'PAGE_TRANSITION'
,p_display_order=>640
,p_column_identifier=>'BL'
,p_column_label=>'Page Transition'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133773389192723)
,p_db_column_name=>'POPUP_TRANSITION'
,p_display_order=>650
,p_column_identifier=>'BM'
,p_column_label=>'Popup Transition'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133895164192724)
,p_db_column_name=>'READ_ONLY_CONDITION_TYPE'
,p_display_order=>660
,p_column_identifier=>'BN'
,p_column_label=>'Read Only Condition Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55133920531192725)
,p_db_column_name=>'READ_ONLY_CONDITION_TYPE_CODE'
,p_display_order=>670
,p_column_identifier=>'BO'
,p_column_label=>'Read Only Condition Type Code'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134032816192726)
,p_db_column_name=>'READ_ONLY_CONDITION_EXP1'
,p_display_order=>680
,p_column_identifier=>'BP'
,p_column_label=>'Read Only Condition Exp1'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134141660192727)
,p_db_column_name=>'READ_ONLY_CONDITION_EXP2'
,p_display_order=>690
,p_column_identifier=>'BQ'
,p_column_label=>'Read Only Condition Exp2'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134253772192728)
,p_db_column_name=>'CACHE_MODE'
,p_display_order=>700
,p_column_identifier=>'BR'
,p_column_label=>'Cache Mode'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134307757192729)
,p_db_column_name=>'CACHED'
,p_display_order=>710
,p_column_identifier=>'BS'
,p_column_label=>'Cached'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134443499192730)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134554066192731)
,p_db_column_name=>'CACHED_BY_USER'
,p_display_order=>730
,p_column_identifier=>'BU'
,p_column_label=>'Cached By User'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134629416192732)
,p_db_column_name=>'CACHE_CONDITION_TYPE'
,p_display_order=>740
,p_column_identifier=>'BV'
,p_column_label=>'Cache Condition Type'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134773099192733)
,p_db_column_name=>'CACHE_CONDITION_EXP_1'
,p_display_order=>750
,p_column_identifier=>'BW'
,p_column_label=>'Cache Condition Exp 1'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134883755192734)
,p_db_column_name=>'CACHE_CONDITION_EXP_2'
,p_display_order=>760
,p_column_identifier=>'BX'
,p_column_label=>'Cache Condition Exp 2'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55134966848192735)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135037956192736)
,p_db_column_name=>'CACHED_REGIONS'
,p_display_order=>780
,p_column_identifier=>'BZ'
,p_column_label=>'Cached Regions'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135187559192737)
,p_db_column_name=>'CREATED_BY'
,p_display_order=>790
,p_column_identifier=>'CA'
,p_column_label=>'Created By'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135217306192738)
,p_db_column_name=>'CREATED_ON'
,p_display_order=>800
,p_column_identifier=>'CB'
,p_column_label=>'Created On'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135310082192739)
,p_db_column_name=>'LAST_UPDATED_BY'
,p_display_order=>810
,p_column_identifier=>'CC'
,p_column_label=>'Last Updated By'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135417315192740)
,p_db_column_name=>'LAST_UPDATED_ON'
,p_display_order=>820
,p_column_identifier=>'CD'
,p_column_label=>'Last Updated On'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135540868192741)
,p_db_column_name=>'COMPONENT_SIGNATURE'
,p_display_order=>830
,p_column_identifier=>'CE'
,p_column_label=>'Component Signature'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135659459192742)
,p_db_column_name=>'BROWSER_CACHE'
,p_display_order=>840
,p_column_identifier=>'CF'
,p_column_label=>'Browser Cache'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135786430192743)
,p_db_column_name=>'DEEP_LINKING'
,p_display_order=>850
,p_column_identifier=>'CG'
,p_column_label=>'Deep Linking'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135849656192744)
,p_db_column_name=>'REJOIN_EXISTING_SESSIONS'
,p_display_order=>860
,p_column_identifier=>'CH'
,p_column_label=>'Rejoin Existing Sessions'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55135992225192745)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55136078222192746)
,p_db_column_name=>'RELOAD_ON_SUBMIT_CODE'
,p_display_order=>880
,p_column_identifier=>'CJ'
,p_column_label=>'Reload On Submit Code'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55136102659192747)
,p_db_column_name=>'WARN_ON_UNSAVED_CHANGES'
,p_display_order=>890
,p_column_identifier=>'CK'
,p_column_label=>'Warn On Unsaved Changes'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(55164184593193325)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'551642'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'WORKSPACE:WORKSPACE_DISPLAY_NAME:APPLICATION_ID:APPLICATION_NAME:PAGE_ID:PAGE_NAME:PAGE_TITLE:PAGE_MODE:USER_INTERFACE_ID:MEDIA_TYPE:TAB_SET:PAGE_ALIAS:PAGE_FUNCTION:ALLOW_DUPLICATE_SUBMISSIONS:INCLUDE_APEX_CSS_JS_YN:FOCUS_CURSOR:HEADER_TEXT:BODY_HEA'
||'DER:FOOTER_TEXT:HELP_TEXT:PAGE_TEMPLATE:PAGE_CSS_CLASSES:PAGE_TEMPLATE_OPTIONS:AUTHORIZATION_SCHEME:AUTHORIZATION_SCHEME_ID:BUILD_OPTION:PAGE_HTML_HEADER:PAGE_HTML_ONLOAD:JAVASCRIPT_FILE_URLS:JAVASCRIPT_CODE:JAVASCRIPT_CODE_ONLOAD:CSS_FILE_URLS:INLIN'
||'E_CSS:PAGE_REQUIRES_AUTHENTICATION:PAGE_ACCESS_PROTECTION:DIALOG_TITLE:DIALOG_HEIGHT:DIALOG_WIDTH:DIALOG_MAX_WIDTH:DIALOG_ATTRIBUTES:DIALOG_CSS_CLASSES:DIALOG_CHAINED:OVERWRITE_NAVIGATION_LIST:NAVIGATION_LIST:NAVIGATION_LIST_ID:NAVIGATION_LIST_TEMPLA'
||'TE:NAVIGATION_LIST_TEMPLATE_ID:NAV_LIST_TEMPLATE_OPTIONS:NAVIGATION_LIST_POSITION:REGIONS:ITEMS:BUTTONS:COMPUTATIONS:VALIDATIONS:PROCESSES:BRANCHES:REPORT_COLUMNS:PAGE_GROUP:PAGE_GROUP_ID:ON_DUP_SUBMISSION_GOTO_URL:ERROR_HANDLING_FUNCTION:ERROR_NOTIF'
||'ICATION_TEXT:FORM_AUTOCOMPLETE:PAGE_TRANSITION:POPUP_TRANSITION:READ_ONLY_CONDITION_TYPE:READ_ONLY_CONDITION_TYPE_CODE:READ_ONLY_CONDITION_EXP1:READ_ONLY_CONDITION_EXP2:CACHE_MODE:CACHED:CACHE_TIMEOUT_SECONDS:CACHED_BY_USER:CACHE_CONDITION_TYPE:CACHE'
||'_CONDITION_EXP_1:CACHE_CONDITION_EXP_2:PAGE_COMMENT:CACHED_REGIONS:CREATED_BY:CREATED_ON:LAST_UPDATED_BY:LAST_UPDATED_ON:COMPONENT_SIGNATURE:BROWSER_CACHE:DEEP_LINKING:REJOIN_EXISTING_SESSIONS:RELOAD_ON_SUBMIT:RELOAD_ON_SUBMIT_CODE:WARN_ON_UNSAVED_CH'
||'ANGES'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(52629268780148348)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(52628311802148339)
,p_button_name=>'New_HIST_OBJECT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47551582506610071)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'New Hist Object'
,p_button_position=>'BELOW_BOX'
,p_button_redirect_url=>'f?p=&APP_ID.:29:&SESSION.::&DEBUG.:RP:P29_PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST,P29_FK_DB_OBJ_OBJECT_LIST:,&P25_PK_DB_OBJ_OBJECT_LIST.'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55013343986829116)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(55012567632829108)
,p_button_name=>'New'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47551582506610071)
...
,p_button_image_alt=>'New'
,p_button_position=>'BELOW_BOX'
,p_button_redirect_url=>'f?p=&APP_ID.:33:&SESSION.::&DEBUG.:RP:P33_PK_REL_DB_OBJ_OBJECT_LIST_PART,P33_FK_DB_OBJ_OBJECT_LIST:,&P25_PK_DB_OBJ_OBJECT_LIST.'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55014708040829130)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(54995050052633737)
...
,p_button_position=>'BELOW_BOX'
,p_button_redirect_url=>'f?p=&APP_ID.:32:&SESSION.::&DEBUG.:RP:P32_PK_DB_OBJ_OBJECT_LIST:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55000724350633762)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(54995050052633737)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
,p_button_condition=>'P25_PK_DB_OBJ_OBJECT_LIST'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_database_action=>'UPDATE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(54999529715633757)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(54995050052633737)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55001172356633762)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(54995050052633737)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55000386745633762)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(54995050052633737)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(54995375959633740)
,p_name=>'P25_PK_DB_OBJ_OBJECT_LIST'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_source=>'PK_DB_OBJ_OBJECT_LIST'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_is_persistent=>'N'
,p_protection_level=>'S'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(54995756345633748)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(54996515969633753)
,p_name=>'P25_OBJECT_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(54997348105633754)
,p_name=>'P25_FK_STD_DB_OBJ_STATUS'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(55093325122932620)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Fk Std Db Obj Status'
,p_source=>'FK_STD_DB_OBJ_STATUS'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select std_name, std_value',
'from t_std',
'where fk_std_group = 641'))
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(47550446954610065)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55014415592829127)
,p_name=>'P25_COMM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(54995050052633737)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Comm'
,p_source=>'COMM'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55014523870829128)
,p_name=>'P25_CREATE_AT'
,p_source_data_type=>'DATE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(54995050052633737)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55014843810829131)
,p_name=>'P25_OBJECT_NAME_RPEV'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(54995050052633737)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Object Name Rpev'
,p_source=>'OBJECT_NAME_RPEV'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55014909349829132)
,p_name=>'P25_FLG_NEU'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55092837410932615)
,p_name=>'P25_FK_STD_DB_PART'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(54995050052633737)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Fk Std Db Part'
,p_source=>'FK_STD_DB_PART'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>30
,p_display_when_type=>'NEVER'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55092964576932616)
,p_name=>'P25_PAGE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Page Id'
,p_source=>'PAGE_ID'
,p_source_type=>'REGION_SOURCE_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55093024770932617)
,p_name=>'P25_APPLICATION_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55093137422932618)
,p_name=>'P25_WORKSPACE_ID'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55093294664932619)
,p_name=>'P25_FK_STD_APEX_OBJ_STATUS'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
,p_prompt=>'Fk Std Apex Obj Status'
,p_source=>'FK_STD_APEX_OBJ_STATUS'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select std_name, std_value',
'from t_std',
'where fk_std_group = 41'))
,p_lov_display_null=>'YES'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(47550446954610065)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55174699527684405)
,p_name=>'P25_PAGE_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55174736575684406)
,p_name=>'P25_PAGE_MODE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55174803010684407)
,p_name=>'P25_PAGE_GROUP'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(55093457642932621)
,p_item_source_plug_id=>wwv_flow_api.id(54995050052633737)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55001977028633765)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(54995050052633737)
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Create Form'
,p_attribute_01=>'REGION_SOURCE'
,p_attribute_05=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55001509463633764)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_api.id(54995050052633737)
,p_process_type=>'NATIVE_FORM_INIT'
...
wwv_flow_api.create_page(
 p_id=>26
,p_user_interface_id=>wwv_flow_api.id(47574086381610126)
,p_name=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_page_mode=>'MODAL'
,p_step_title=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200629211007'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(52629307825148349)
,p_plug_name=>'REl_Object_list_object_hist'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_query_type=>'TABLE'
,p_query_table=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_include_rowid_column=>false
,p_is_editable=>false
,p_plug_source_type=>'NATIVE_FORM'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55008911769774253)
,p_plug_name=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(55009057953774253)
,p_name=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_show_nulls_as=>'-'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ANNE'
,p_internal_uid=>55009057953774253
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55009462362774270)
,p_db_column_name=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Pk Rel Db Obj Object List Object Hist'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55009755316774271)
,p_db_column_name=>'FK_DB_OBJ_OBJECT_LIST'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Fk Db Obj Object List'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55010147196774273)
,p_db_column_name=>'FK_DB_OBJ_OBJECT_LIST_PREV'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Fk Db Obj Object List Prev'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55010513450774275)
,p_db_column_name=>'CREATED_AT'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Created At'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(55037167362483721)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'550372'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST:FK_DB_OBJ_OBJECT_LIST:FK_DB_OBJ_OBJECT_LIST_PREV:CREATED_AT'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55012228092829105)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(52629307825148349)
,p_button_name=>'Save'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47551582506610071)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55011870414829101)
,p_name=>'P26_PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(52629307825148349)
,p_item_source_plug_id=>wwv_flow_api.id(52629307825148349)
,p_prompt=>'Pk Rel Db Obj Object List Object Hist'
,p_source=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_api.id(47550446954610065)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55011966532829102)
,p_name=>'P26_FK_DB_OBJ_OBJECT_LIST'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(52629307825148349)
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select PK_DB_OBJ_OBJECT_LIST || '' '' || Object_type || '' '' || Object_name d, pk_db_obj_object_list',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55012066568829103)
,p_name=>'P26_FK_DB_OBJ_OBJECT_LIST_PREV'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(52629307825148349)
,p_item_source_plug_id=>wwv_flow_api.id(52629307825148349)
,p_prompt=>'Fk Db Obj Object List Prev'
,p_source=>'FK_DB_OBJ_OBJECT_LIST_PREV'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select PK_DB_OBJ_OBJECT_LIST || '' '' || Object_type || '' '' || Object_name d, pk_db_obj_object_list',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55012104816829104)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55012396779829106)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'New'
,p_attribute_02=>'T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_attribute_03=>'P26_PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_attribute_04=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_attribute_11=>'I:U:D'
,p_attribute_12=>'Y'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(52629424049148350)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_api.id(52629307825148349)
,p_process_type=>'NATIVE_FORM_INIT'
,p_process_name=>'Initialize form T_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
end;
/
...
,p_user_interface_id=>wwv_flow_api.id(47574086381610126)
,p_name=>'Trigger'
,p_step_title=>'Trigger'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200629210747'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55013401633829117)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55039093035542281)
,p_plug_name=>'Trigger'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47494371775610010)
,p_plug_display_sequence=>20
,p_plug_display_point=>'BODY'
,p_query_type=>'SQL'
,p_plug_source=>'select * from User_triggers'
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(55039101650542281)
,p_name=>'Trigger'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
,p_show_nulls_as=>'-'
...
,p_show_detail_link=>'C'
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_detail_link=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.:RP:P28_TRIGGER_NAME:#TRIGGER_NAME#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#app_ui/img/icons/apex-edit-pencil.png" class="apex-edit-pencil" alt="">'
,p_owner=>'ANNE'
,p_internal_uid=>55039101650542281
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55039558632542284)
,p_db_column_name=>'TRIGGER_NAME'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Trigger Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55039919212542285)
,p_db_column_name=>'TRIGGER_TYPE'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Trigger Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55040359118542285)
,p_db_column_name=>'TRIGGERING_EVENT'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Triggering Event'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55040788457542285)
,p_db_column_name=>'TABLE_OWNER'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Table Owner'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55041150845542287)
,p_db_column_name=>'BASE_OBJECT_TYPE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Base Object Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55041583191542287)
,p_db_column_name=>'TABLE_NAME'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Table Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55041900732542287)
,p_db_column_name=>'COLUMN_NAME'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Column Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55042389824542289)
,p_db_column_name=>'REFERENCING_NAMES'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Referencing Names'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55042747905542289)
,p_db_column_name=>'WHEN_CLAUSE'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'When Clause'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55043128686542289)
,p_db_column_name=>'STATUS'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Status'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55043571675542289)
,p_db_column_name=>'DESCRIPTION'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Description'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55043931126542290)
,p_db_column_name=>'ACTION_TYPE'
,p_display_order=>12
,p_column_identifier=>'L'
,p_column_label=>'Action Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55044394669542290)
,p_db_column_name=>'TRIGGER_BODY'
,p_display_order=>13
,p_column_identifier=>'M'
,p_column_label=>'Trigger Body'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55044728278542292)
,p_db_column_name=>'CROSSEDITION'
,p_display_order=>14
,p_column_identifier=>'N'
,p_column_label=>'Crossedition'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55045109516542292)
,p_db_column_name=>'BEFORE_STATEMENT'
,p_display_order=>15
,p_column_identifier=>'O'
,p_column_label=>'Before Statement'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55045585302542292)
,p_db_column_name=>'BEFORE_ROW'
,p_display_order=>16
,p_column_identifier=>'P'
,p_column_label=>'Before Row'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55045954788542292)
,p_db_column_name=>'AFTER_ROW'
,p_display_order=>17
,p_column_identifier=>'Q'
,p_column_label=>'After Row'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55046380360542293)
,p_db_column_name=>'AFTER_STATEMENT'
,p_display_order=>18
,p_column_identifier=>'R'
,p_column_label=>'After Statement'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55046709911542293)
,p_db_column_name=>'INSTEAD_OF_ROW'
,p_display_order=>19
,p_column_identifier=>'S'
,p_column_label=>'Instead Of Row'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55047178472542293)
,p_db_column_name=>'FIRE_ONCE'
,p_display_order=>20
,p_column_identifier=>'T'
,p_column_label=>'Fire Once'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(55047552271542295)
,p_db_column_name=>'APPLY_SERVER_ONLY'
,p_display_order=>21
,p_column_identifier=>'U'
,p_column_label=>'Apply Server Only'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(55049442315561167)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'550495'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'TRIGGER_NAME:TRIGGER_TYPE:TRIGGERING_EVENT:TABLE_OWNER:BASE_OBJECT_TYPE:TABLE_NAME:COLUMN_NAME:REFERENCING_NAMES:WHEN_CLAUSE:STATUS:DESCRIPTION:ACTION_TYPE:TRIGGER_BODY:CROSSEDITION:BEFORE_STATEMENT:BEFORE_ROW:AFTER_ROW:AFTER_STATEMENT:INSTEAD_OF_ROW'
||':FIRE_ONCE:APPLY_SERVER_ONLY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55013678590829119)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(55013401633829117)
,p_button_name=>'DROP'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47551582506610071)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55013574550829118)
,p_name=>'P28_TRIGGER_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(55013401633829117)
,p_prompt=>'Trigger Name'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_api.id(47550446954610065)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55013714726829120)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'New'
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'begin',
'  execute immediate ''DROP TRIGGER '' || :P28_TRIGGER_NAME ;',
'  commit;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(55013678590829119)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>29
,p_user_interface_id=>wwv_flow_api.id(47574086381610126)
,p_name=>'Add Object Hist'
,p_page_mode=>'NON_MODAL'
,p_step_title=>'Add Object Hist'
,p_autocomplete_on_off=>'OFF'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200702211928'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55051444717597101)
,p_plug_name=>'Create Form'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(47495434063610012)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55055804547597110)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(55051444717597101)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47551582506610071)
...
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
,p_button_condition=>'P29_PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_grid_new_grid=>false
,p_database_action=>'UPDATE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55054699895597107)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(55051444717597101)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55056282935597110)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(55051444717597101)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55055496061597109)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(55051444717597101)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55051860233597101)
,p_name=>'P29_PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(55051444717597101)
,p_item_source_plug_id=>wwv_flow_api.id(55051444717597101)
,p_prompt=>'New'
,p_source=>'PK_REL_DB_OBJ_OBJECT_LIST_OBJECT_HIST'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55052265743597106)
,p_name=>'P29_FK_DB_OBJ_OBJECT_LIST'
,p_source_data_type=>'NUMBER'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(55051444717597101)
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select PK_DB_OBJ_OBJECT_LIST || '' '' || Object_type || '' '' || Object_name || '' '' || application_id || '' '' || page_id || '' '' || page_name d, pk_db_obj_object_list',
'from t_db_obj_object_list'))
,p_lov_display_null=>'YES'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55052605957597106)
,p_name=>'P29_FK_DB_OBJ_OBJECT_LIST_PREV'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(55051444717597101)
,p_item_source_plug_id=>wwv_flow_api.id(55051444717597101)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55053098186597107)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55057021253597110)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(55051444717597101)
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Create Form'
,p_attribute_01=>'REGION_SOURCE'
,p_attribute_05=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55056629868597110)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_api.id(55051444717597101)
,p_process_type=>'NATIVE_FORM_INIT'
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200629214437'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55067560567714925)
,p_plug_name=>'Create Form'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55073552494714943)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47471272030609993)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55073939180714943)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(55073552494714943)
,p_button_name=>'CANCEL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55075572451714948)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(55073552494714943)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
,p_button_redirect_url=>'javascript:apex.confirm(htmldb_delete_message,''DELETE'');'
,p_button_execute_validations=>'N'
,p_button_condition=>'P32_PK_DB_OBJ_OBJECT_LIST'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_grid_new_grid=>false
,p_database_action=>'DELETE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55075916216714948)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(55073552494714943)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55076306621714948)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(55073552494714943)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55067940821714926)
,p_name=>'P32_PK_DB_OBJ_OBJECT_LIST'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
,p_item_source_plug_id=>wwv_flow_api.id(55067560567714925)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Pk Db Obj Object List'
,p_source=>'PK_DB_OBJ_OBJECT_LIST'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55068330907714935)
,p_name=>'P32_OBJECT_TYPE'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
,p_item_source_plug_id=>wwv_flow_api.id(55067560567714925)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55068749234714935)
,p_name=>'P32_FK_BAS_DB_PART'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
,p_item_source_plug_id=>wwv_flow_api.id(55067560567714925)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Fk Bas Db Part'
,p_source=>'FK_BAS_DB_PART'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55069190332714937)
,p_name=>'P32_OBJECT_NAME'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
,p_item_source_plug_id=>wwv_flow_api.id(55067560567714925)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55069577049714939)
,p_name=>'P32_OBJECT_NAME_RPEV'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
,p_item_source_plug_id=>wwv_flow_api.id(55067560567714925)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55069981808714939)
,p_name=>'P32_FK_STD_DB_OBJ_STATUS'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
,p_item_source_plug_id=>wwv_flow_api.id(55067560567714925)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55070389735714940)
,p_name=>'P32_COMM'
,p_source_data_type=>'VARCHAR2'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55070758855714940)
,p_name=>'P32_CREATE_AT'
,p_source_data_type=>'DATE'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(55067560567714925)
,p_item_source_plug_id=>wwv_flow_api.id(55067560567714925)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(55074070146714943)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(55073939180714943)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(55074855898714946)
,p_event_id=>wwv_flow_api.id(55074070146714943)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55077111652714950)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(55067560567714925)
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Create Form'
,p_attribute_01=>'REGION_SOURCE'
,p_attribute_05=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55077508033714950)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55076714509714948)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_api.id(55067560567714925)
,p_process_type=>'NATIVE_FORM_INIT'
...
wwv_flow_api.create_page(
 p_id=>33
,p_user_interface_id=>wwv_flow_api.id(47574086381610126)
,p_name=>'T_REL_DB_OBJ_OBJECT_LIST_PART'
,p_page_mode=>'NON_MODAL'
,p_step_title=>'T_REL_DB_OBJ_OBJECT_LIST_PART'
,p_autocomplete_on_off=>'OFF'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200629213755'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55078281725729612)
,p_plug_name=>'Create Form'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47470254185609993)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_query_type=>'TABLE'
,p_query_table=>'T_REL_DB_OBJ_OBJECT_LIST_PART'
,p_include_rowid_column=>false
,p_is_editable=>true
,p_edit_operations=>'i:u:d'
,p_lost_update_check_type=>'VALUES'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(55081422259729625)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47471272030609993)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55081889012729626)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(55081422259729625)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(47551582506610071)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55083449386729629)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(55081422259729625)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
,p_button_redirect_url=>'javascript:apex.confirm(htmldb_delete_message,''DELETE'');'
,p_button_execute_validations=>'N'
,p_button_condition=>'P33_PK_REL_DB_OBJ_OBJECT_LIST_PART'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_grid_new_grid=>false
,p_database_action=>'DELETE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55083868317729631)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(55081422259729625)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(55084232532729631)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(55081422259729625)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55078673003729614)
,p_name=>'P33_PK_REL_DB_OBJ_OBJECT_LIST_PART'
,p_source_data_type=>'NUMBER'
,p_is_primary_key=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(55078281725729612)
,p_item_source_plug_id=>wwv_flow_api.id(55078281725729612)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Pk Rel Db Obj Object List Part'
,p_source=>'PK_REL_DB_OBJ_OBJECT_LIST_PART'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(47550446954610065)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55079035397729620)
,p_name=>'P33_FK_DB_OBJ_OBJECT_LIST'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(55078281725729612)
,p_item_source_plug_id=>wwv_flow_api.id(55078281725729612)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55079403417729620)
,p_name=>'P33_FK_BAS_DB_PART'
,p_source_data_type=>'NUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(55078281725729612)
,p_item_source_plug_id=>wwv_flow_api.id(55078281725729612)
...
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select std_value || '': '' || std_name || '' ('' || comm || '')'' d, std_value',
'from t_std',
'where fk_std_group = 642'))
,p_lov_display_null=>'YES'
,p_cSize=>32
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(47550446954610065)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(55079889724729621)
,p_name=>'P33_CREATION_AT'
,p_source_data_type=>'DATE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(55078281725729612)
,p_item_source_plug_id=>wwv_flow_api.id(55078281725729612)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Creation At'
,p_source=>'CREATION_AT'
,p_source_type=>'REGION_SOURCE_COLUMN'
,p_display_as=>'NATIVE_DATE_PICKER'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(55081908593729626)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(55081889012729626)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(55082768206729628)
,p_event_id=>wwv_flow_api.id(55081908593729626)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55085057953729634)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(55078281725729612)
,p_process_type=>'NATIVE_FORM_DML'
,p_process_name=>'Process form Create Form'
,p_attribute_01=>'REGION_SOURCE'
,p_attribute_05=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55085401269729634)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(55084633232729632)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_region_id=>wwv_flow_api.id(55078281725729612)
,p_process_type=>'NATIVE_FORM_INIT'
