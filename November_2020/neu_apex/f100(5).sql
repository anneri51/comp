...
--   Date and Time:   07:22 Wednesday July 1, 2020
--   Exported By:     ANNE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20200630223220'
...
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'PK_DB_OBJ_OBJECT_LIST:OBJECT_TYPE:OBJECT_NAME:OBJECT_NAME_RPEV:CREATE_AT:FLG_NEU:ALLOBJ_OBJECT_NAME:FK_STD_DB_PART:PAGE_ID:APPLICATION_ID:WORKSPACE_ID:PAGE_TITLE:PAGE_MODE:PAGE_NAME:PAGE_GROUP:PAGE_GROUP_ID:OBJ_STATUS:APEX_OBJ_STATUS:COMM:FK_STD_APEX'
||'_OBJ_STATUS:FK_STD_DB_OBJ_STATUS:'
,p_sort_column_1=>'PAGE_ID'
,p_sort_direction_1=>'ASC'
);
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55181289481712535)
...
,p_operator=>'='
,p_expr=>'5'
,p_condition_sql=>' (case when ("FK_STD_APEX_OBJ_STATUS" = to_number(#APXWS_EXPR#)) then #APXWS_HL_ID# end) '
,p_condition_display=>'#APXWS_COL_NAME# = #APXWS_EXPR_NUMBER#  '
,p_enabled=>'Y'
,p_highlight_sequence=>10
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55181699307712535)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_name=>'ok'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55182073195712537)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_name=>'not ok'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(55180859262712534)
,p_report_id=>wwv_flow_api.id(54994269702624282)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'APPLICATION_ID'
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200630153250'
);
wwv_flow_api.create_page_plug(
...
,p_protection_level=>'C'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200629212242'
);
wwv_flow_api.create_page_plug(
