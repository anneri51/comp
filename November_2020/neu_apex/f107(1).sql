...
--   Application:     107
--   Name:            PARTEC
--   Date and Time:   11:37 Thursday August 20, 2020
--   Exported By:     ANNE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20200820113348'
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200819193451'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5308078414335310)
,p_plug_name=>'Step 3'
,p_region_template_options=>'#DEFAULT#:t-Wizard--hideStepsXSmall'
,p_plug_template=>wwv_flow_api.id(5138571886283855)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5308160135335310)
,p_plug_name=>'Step 3'
,p_parent_plug_id=>wwv_flow_api.id(5308078414335310)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5100723994283838)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5309823720335311)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5308078414335310)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(5190223434283891)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5310168283335311)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5308078414335310)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5310048270335311)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5308078414335310)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5311519823335311)
,p_branch_action=>'f?p=&APP_ID.:23:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5310168283335311)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5310828919335311)
,p_branch_action=>'f?p=&APP_ID.:21:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5310048270335311)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5309564932335311)
,p_name=>'P22_ITEM1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5308160135335310)
,p_prompt=>'ITEM 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5316447763335313)
,p_plug_name=>'Step 5'
,p_region_template_options=>'#DEFAULT#:t-Wizard--hideStepsXSmall'
,p_plug_template=>wwv_flow_api.id(5138571886283855)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5316595531335313)
,p_plug_name=>'Step 5'
,p_parent_plug_id=>wwv_flow_api.id(5316447763335313)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5100723994283838)
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5318234993335314)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(5316447763335313)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(5190223434283891)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5318575791335314)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5316447763335313)
,p_button_name=>'NEXT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5318433492335314)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(5316447763335313)
,p_button_name=>'PREVIOUS'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5319912924335315)
,p_branch_action=>'f?p=&APP_ID.:25:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5318575791335314)
,p_branch_sequence=>20
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(5319203728335314)
,p_branch_action=>'f?p=&APP_ID.:23:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'BEFORE_VALIDATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(5318433492335314)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5317990979335314)
,p_name=>'P24_ITEM1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5316595531335313)
,p_prompt=>'ITEM 1'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_label_alignment=>'RIGHT'
