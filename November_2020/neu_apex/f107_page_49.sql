...
--   Application:     107
--   Name:            PARTEC
--   Date and Time:   12:58 Thursday August 27, 2020
--   Exported By:     ANNE
--   Flashback:       0
...
,p_name=>'Zuordnung Projekt Land'
,p_alias=>'ZUORDNUNG-PROJEKT-LAND'
,p_step_title=>'Zuordnung Projekt Land'
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'ANNE'
,p_last_upd_yyyymmddhh24miss=>'20200827125827'
);
end;
/
